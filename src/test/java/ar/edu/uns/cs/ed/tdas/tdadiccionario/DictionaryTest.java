...
public class DictionaryTest {
	...
	private Dictionary<Integer, Integer> getDictionary() {
		...
		return new DictionaryConHash<Integer, Integer>();
	...
	public void isEmpty() {
	  ...
	  try {
			...
			assertTrue("El Diccionario está vacío después de insertar 1 elemento",
					!s.isEmpty());

			s.insert(0, 1);

			assertTrue("El Diccionario está vacío después de insertar 2 elementos",
					!s.isEmpty());

			s.insert(1, 0);

			assertTrue("El Diccionario está vacío después de insertar 3 elementos",
					!s.isEmpty());
